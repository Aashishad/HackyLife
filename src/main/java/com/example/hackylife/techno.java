...
public class techno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardAdapter.addCardItem(new CardItem(R.string.title_1, R.string.techno_1));
        mCardAdapter.addCardItem(new CardItem(R.string.title_2, R.string.techno_2));
        mCardAdapter.addCardItem(new CardItem(R.string.title_3, R.string.techno_3));
        mCardAdapter.addCardItem(new CardItem(R.string.title_4, R.string.techno_4));
