...
public class foodanddrink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardAdapter.addCardItem(new CardItem(R.string.title_1, R.string.food_1));
        mCardAdapter.addCardItem(new CardItem(R.string.title_2, R.string.food_2));
        mCardAdapter.addCardItem(new CardItem(R.string.title_3, R.string.food_3));
        mCardAdapter.addCardItem(new CardItem(R.string.title_4, R.string.food_4));
