...
public class tips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardAdapter.addCardItem(new CardItem(R.string.title_1, R.string.tips_1));
        mCardAdapter.addCardItem(new CardItem(R.string.title_2, R.string.tips_2));
        mCardAdapter.addCardItem(new CardItem(R.string.title_3, R.string.tips_3));
        mCardAdapter.addCardItem(new CardItem(R.string.title_4, R.string.tips_4));
